...
\section{Extras}
To complement \textbf{GTerm}, some extra, terminal related, items are included. 
...
\end{verbatim}
The address should be a dotted decimal IPV4 address or a host name which can be resoled to such an address. The port should be the
